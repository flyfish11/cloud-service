...
public class SysPermissionController {
	...
	public Result findPermissions1(@RequestParam Map<String, Object> params) {
		Page<SysPermission> permissions = sysPermissionService.findPermissions(params);
		return ResultUtil.success(permissions.getData());
	}
}
