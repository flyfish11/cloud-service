...
public interface SysPermissionDao {
	...
	@Insert("insert into sys_permission(id,permission, name, createTime, updateTime) values(#{id},#{permission}, #{name}, #{createTime}, #{createTime})")
	...
	List<SysPermission> selectPermission(Map<String, Object> params);
