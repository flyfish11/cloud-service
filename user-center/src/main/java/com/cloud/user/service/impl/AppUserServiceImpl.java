...
public class AppUserServiceImpl implements AppUserService {
    ...
    public void addAppUser(AppUser appUser) {
        ...
        if (StringUtils.isBlank(appUser.getFullName())) {
    ...
    public LoginAppUser findByAccount(String account) {
        AppUser appUser = userCredentialsDao.findUserByAccount(account);
        if (appUser != null) {
    ...
    @Override
    public List<AppUser> findUsers2(Map<String, Object> params) {
        params.put("start",0);
        params.put("length",10);
        List<AppUser> list = appUserDao.findusers(params);
        return list;
    }
    @Override
    public List<AppUser> findUsers1(Map<String, Object> params) {
        PageUtil.pageUtil(params);
        return  appUserDao.findData(params);
    }
     ...
     */
    @Override
    public void bindingPhone(String userId, String phone) {
